...
import static harvestmoon.helpers.CropHelper.destroyCrop;
import static harvestmoon.helpers.CropHelper.harvestCrop;
...
public class BlockCrop extends BlockBase implements IPlantable {
    public BlockCrop() {
