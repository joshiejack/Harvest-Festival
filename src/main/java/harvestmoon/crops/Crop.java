...
public class Crop {
    ...
    public final String getCropName(boolean isGiant) {
        String name = Text.translate("crop." + StringUtils.replace(getUnlocalizedName(), "_", "."));
        if (!isGiant) {
            return name;
        } else {
            String text = Text.translate("crop.giant.format");
            String giant = Text.translate("crop.giant");            
    ...
    public final String getSeedsName(boolean isGiant) {
        ...
        if(isGiant) {
            ...
            text = StringUtils.replace(text, "%G", Text.translate("crop.giant"));
        }
