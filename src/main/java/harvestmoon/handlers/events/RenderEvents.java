...
import static harvestmoon.helpers.CalendarHelper.getClientDay;
import static harvestmoon.helpers.CalendarHelper.getClientSeason;
import static harvestmoon.helpers.CalendarHelper.getClientYear;
import harvestmoon.helpers.ClientHelper;
import harvestmoon.helpers.RatingHelper;
...
public class RenderEvents {
    ...
    public void renderTick(TickEvent.RenderTickEvent event) {
        ...
        if (gui instanceof GuiContainer && mc.thePlayer.inventory.getItemStack() == null) {
            ...
            Point mouse = ClientHelper.getMouse(container);
