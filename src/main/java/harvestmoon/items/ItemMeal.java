...
import static harvestmoon.helpers.PlayerHelper.affectStats;
import static harvestmoon.lib.ModInfo.MEALPATH;
...
public class ItemMeal extends ItemBaseMeta {
    @Override
    public String getItemStackDisplayName(ItemStack stack) {
        if (stack.hasTagCompound()) {
            return Text.translate("meal." + stack.stackTagCompound.getString("FoodName"));
    ...
    public void addInformation(ItemStack stack, EntityPlayer player, List list, boolean debug) {
        if (stack.hasTagCompound() && debug) {
            list.add(Text.translate("meal.level") + " : " + stack.stackTagCompound.getInteger("FoodLevel"));
            list.add(Text.translate("meal.sat") + " : " + stack.stackTagCompound.getFloat("FoodSaturation"));
            list.add(Text.translate("meal.stamina") + " : " + stack.stackTagCompound.getInteger("FoodStamina"));
            list.add(Text.translate("meal.fatigue") + " : " + stack.stackTagCompound.getInteger("FoodFatigue"));
        }
    }
