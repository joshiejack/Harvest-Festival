...
public class ChunkTester {
    public static void activate(World world, int xCoord, int yCoord, int zCoord) {
        ...
        HarvestFestival.logger.log(Level.INFO, "Starting: " + current);
        ...
        HarvestFestival.logger.log(Level.INFO, "Ending: " + System.currentTimeMillis());
        HarvestFestival.logger.log(Level.INFO, world.isRemote + "Total MS: " + (complete - current));
        // }
    }
}
