...
public class HFCrops {
    ...
    public static final Crop CUCUMBER = registerCrop("cucumber").setItem(getCropStack(Crops.CUCUMBER)).setValue(300, 35).setStages(4, 7, 9, 10).setRegrow(7).setSeedColours(0x36B313).setAnimalFoodType(FRUIT);
    ...
    public static final Crop TOMATO = registerCrop("tomato").setItem(getCropStack(Crops.TOMATO)).setValue(230, 40).setStages(2, 4, 6, 9, 10).setRegrow(7).setSeedColours(0XE60820).setSeasons(SUMMER).setAnimalFoodType(FRUIT);
    public static final Crop CORN = registerCrop("corn").setItem(getCropStack(Crops.CORN)).setValue(480, 40).setStages(3, 8, 12, 14, 15).setRegrow(12).setSeedColours(0XD4BD45).setSeasons(SUMMER);
    public static final Crop PUMPKIN = registerCrop("pumpkin").setItem(new ItemStack(Blocks.PUMPKIN)).setValue(350, 220).setStages(15).setSeedColours(0XE09A39)
    ...
    //Autumn Crops
    public static final Crop EGGPLANT = registerCrop("eggplant").setItem(getCropStack(Crops.EGGPLANT)).setValue(320, 50).setStages(3, 7, 9, 10).setRegrow(7).setSeedColours(0XA25CC4).setSeasons(AUTUMN);
    ...
    public static final Crop SWEET_POTATO = registerCrop("sweet_potato").setItem(getCropStack(Crops.SWEET_POTATO)).setValue(400, 45).setStages(3, 5, 6).setRegrow(4).setSeedColours(0XD82AAC)
    ...
    public static final Crop BEETROOT = registerCrop("beetroot").setItem(Items.BEETROOT).setValue(250, 180).setStages(Blocks.BEETROOTS, 2, 5, 8, 11).setSeedColours(0x690000)
