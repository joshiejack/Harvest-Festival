...
public class HFCrops {
    ...
    //Spring Crops
    public static final Crop TURNIP = registerCrop("turnip").setItem(getCropStack(Crops.TURNIP)).setValue(240, 40).setStages(2, 4, 5).setSeedColours(0xFFFFFF);
    public static final Crop POTATO = registerCrop("potato").setItem(Items.POTATO).setValue(320, 70).setStages(Blocks.POTATOES, 1, 2, 3, 4, 5, 6, 7, 8).setSeedColours(0xBE8D2B);
    public static final Crop CUCUMBER = registerCrop("cucumber").setItem(getCropStack(Crops.CUCUMBER)).setValue(450, 30).setStages(4, 7, 9, 10).setRegrow(5).setSeedColours(0x36B313).setAnimalFoodType(FRUIT);
    public static final Crop STRAWBERRY = registerCrop("strawberry").setItem(getCropStack(Crops.STRAWBERRY)).setValue(660, 20).setStages(3, 6, 8, 9).setRegrow(7).setSeedColours(0xFF7BEA)
                                            .setAnimalFoodType(FRUIT).setPurchaseRules(new SpecialRulesQuest("strawberry"));
    public static final Crop CABBAGE = registerCrop("cabbage").setItem(getCropStack(Crops.CABBAGE)).setValue(950, 180).setStages(4, 9, 14, 15).setSeedColours(0x8FFF40)
                                            .setPurchaseRules(new SpecialRulesQuest("cabbage"));

    //Summer Crops
    public static final Crop ONION = registerCrop("onion").setItem(getCropStack(Crops.ONION)).setValue(180, 50).setStages(3, 7, 8).setSeedColours(0XDCC307).setSeasons(SUMMER);
    public static final Crop TOMATO = registerCrop("tomato").setItem(getCropStack(Crops.TOMATO)).setValue(320, 20).setStages(2, 4, 6, 9, 10).setRegrow(7).setSeedColours(0XE60820).setSeasons(SUMMER).setAnimalFoodType(FRUIT);
    public static final Crop CORN = registerCrop("corn").setItem(getCropStack(Crops.CORN)).setValue(480, 40).setStages(3, 7, 9, 14, 15).setRegrow(10).setSeedColours(0XD4BD45).setSeasons(SUMMER);
    public static final Crop PUMPKIN = registerCrop("pumpkin").setItem(new ItemStack(Blocks.PUMPKIN)).setValue(540, 120).setStages(15).setSeedColours(0XE09A39)
                                        .setSeasons(SUMMER).setIngredient(2, 0.3F).setGrowthHandler(new GrowthHandlerSide(Blocks.PUMPKIN)).setPurchaseRules(new SpecialRulesQuest("pumpkin"));
    public static final Crop PINEAPPLE = registerCrop("pineapple").setItem(getCropStack(Crops.PINEAPPLE)).setValue(1250, 140).setStages(5, 10, 15, 20, 21).setRegrow(16).setSeedColours(0XD7CF00)
                                        .setSeasons(SUMMER).setAnimalFoodType(FRUIT).setPurchaseRules(new SpecialRulesQuest("pineapple"));
    public static final Crop WATERMELON = registerCrop("watermelon").setItem(Items.MELON).setValue(820, 20).setStages(11).setSeedColours(0xc92b3e)
                                        .setSeasons(SUMMER).setAnimalFoodType(FRUIT).setGrowthHandler(new GrowthHandlerSide(Blocks.MELON_BLOCK)).setPurchaseRules(new SpecialRulesQuest("watermelon"));
    //Summer Trees
    public static final Crop BANANA = registerTree("banana").setStageLength(9, 9, 14, 23).setFruitRegrow(4).setItem(getCropStack(Crops.BANANA)).setValue(2500, 240).setSeedColours(0xFFEF6A).setSeasons(SUMMER);
    public static final Crop ORANGE = registerTree("orange").setStageLength(7, 16, 12, 14).setItem(getCropStack(Crops.ORANGE)).setValue(2800, 170).setSeedColours(0xEDB325).setSeasons(SUMMER);
    public static final Crop PEACH = registerTree("peach").setStageLength(5, 10, 10, 11).setItem(getCropStack(Crops.PEACH)).setValue(3000, 190).setSeedColours(0xFFB0A5).setSeasons(SUMMER);

    //Autumn Crops
    public static final Crop EGGPLANT = registerCrop("eggplant").setItem(getCropStack(Crops.EGGPLANT)).setValue(320, 30).setStages(1, 4, 9, 10).setRegrow(5).setSeedColours(0XA25CC4).setSeasons(AUTUMN);
    public static final Crop SPINACH = registerCrop("spinach").setItem(getCropStack(Crops.SPINACH)).setValue(280, 50).setStages(2, 5, 6).setSeedColours(0X90AE15).setSeasons(AUTUMN);
    public static final Crop CARROT = registerCrop("carrot").setItem(Items.CARROT).setValue(380, 80).setStages(Blocks.CARROTS, 1, 2, 3, 4, 5, 6, 7, 8).setSeedColours(0XF8AC33).setSeasons(AUTUMN);
    public static final Crop SWEET_POTATO = registerCrop("sweet_potato").setItem(getCropStack(Crops.SWEET_POTATO)).setValue(580, 90).setStages(3, 5, 6).setSeedColours(0XD82AAC)
                                            .setSeasons(AUTUMN).setPurchaseRules(new SpecialRulesQuest("sweetpotato"));
    public static final Crop GREEN_PEPPER = registerCrop("green_pepper").setItem(getCropStack(Crops.GREEN_PEPPER)).setValue(770, 30).setStages(1, 3, 4, 7, 8).setRegrow(5).setSeedColours(0x56D213)
                                            .setSeasons(AUTUMN).setPurchaseRules(new SpecialRulesQuest("greenpepper"));
    public static final Crop BEETROOT = registerCrop("beetroot").setItem(Items.BEETROOT).setValue(530, 110).setStages(Blocks.BEETROOTS, 2, 5, 8, 11).setSeedColours(0x690000)
                                            .setSeasons(AUTUMN).setPurchaseRules(new SpecialRulesQuest("beetroot"));

    //Autumn Trees
    public static final Crop APPLE = registerTree("apple").setStageLength(5, 10, 10, 11).setItem(new ItemStack(Items.APPLE)).setValue(1500, 100).setSeedColours(0xE73921).setSeasons(AUTUMN);
    public static final Crop GRAPE = registerTree("grape").setStageLength(7, 16, 12, 14).setItem(getCropStack(Crops.GRAPE)).setValue(2700, 170).setSeedColours(0xD58EF8).setSeasons(AUTUMN);
    ...
    public static final Crop WHEAT = registerCrop("wheat").setItem(Items.WHEAT).setValue(150, 100).setStages(Blocks.WHEAT, 2, 5, 9, 12, 15, 20, 27, 28).setSeedColours(0XEAC715).setSeasons(SPRING, SUMMER, AUTUMN)
                                        .setIngredient(1, 0.1F).setAnimalFoodType(AnimalFoodType.GRASS).setRequiresSickle(0);
    //Nether Crops
    public static final Crop NETHER_WART = registerCrop("nether_wart").setItem(Items.NETHER_WART).setValue(7500, 20).setStages(Blocks.NETHER_WART, 1, 2, 3, 4).setRegrow(1).setSeedColours(0x8B0000)
