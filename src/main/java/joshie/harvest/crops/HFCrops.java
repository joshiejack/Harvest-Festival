...
public class HFCrops {
    ...
    public static void preInit() {
        ...
        potato = HFApi.CROPS.registerCrop("potato", 150, 80, 8, 0, 0, 0xBE8D2B, SPRING).setDropHandler(new DropHandlerPotato()).setCropIconHandler(new IconHandlerSeedFood(Blocks.potatoes));
