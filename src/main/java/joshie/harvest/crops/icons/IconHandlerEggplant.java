...
public class IconHandlerEggplant extends AbstractIconHandler {
    ...
    public void registerIcons(IIconRegister register) {
        ...
        for (int i = 0; i < stageIcons.length; i++) {
            stageIcons[i] = register.registerIcon(HFModInfo.CROPPATH + HFCrops.eggplant.getUnlocalizedName() + "_" + (i + 1));
        }
    }
}
