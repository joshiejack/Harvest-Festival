    ...
    public int handleHookRetraction() {
        if (worldObj.isRemote) {
            ...
            if (caughtEntity != null) {
                ...
                for (ItemStack itemstack : worldObj.getLootTableManager().getLootTableFromLocation(HFFishing.FISHING_ROD.getLootTable(angler.getHeldItemMainhand())).generateLootForPools(rand, lootcontext$builder.build())) {
