...
public class HFGathering {
    ...
    public static void init() {
        ...
        HFApi.gathering.registerGathering(NATURE.getStateFromEnum(GRAPES), 1D, SUMMER);
        HFApi.gathering.registerGathering(NATURE.getStateFromEnum(MATSUTAKE), 0.1D, AUTUMN);
        HFApi.gathering.registerGathering(NATURE.getStateFromEnum(TOADSTOOL), 0.5D, AUTUMN);
        HFApi.gathering.registerGathering(NATURE.getStateFromEnum(YELLOW_GRASS), 0.4D, SPRING);
        HFApi.gathering.registerGathering(NATURE.getStateFromEnum(ORANGE_GRASS), 0.5D, SPRING, AUTUMN);
        HFApi.gathering.registerGathering(NATURE.getStateFromEnum(BLUE_GRASS), 0.5D, SUMMER);
        HFApi.gathering.registerGathering(NATURE.getStateFromEnum(GREEN_GRASS), 0.5D, SUMMER);
        HFApi.gathering.registerGathering(NATURE.getStateFromEnum(RED_GRASS), 0.45D, SUMMER, AUTUMN);
        HFApi.gathering.registerGathering(NATURE.getStateFromEnum(PURPLE_GRASS), 0.4D, SUMMER);
        HFApi.gathering.registerGathering(NATURE.getStateFromEnum(INDIGO_GRASS), 0.5D, SUMMER);
        HFApi.gathering.registerGathering(NATURE.getStateFromEnum(WHITE_GRASS), 0.25D, AUTUMN);
