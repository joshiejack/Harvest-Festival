...
public class HFMining {
    ...
    public static void init() {
        ...
        HFApi.mining.registerOre(all, ORE.getStateFromEnum(Ore.ROCK), 300D, SPRING, SUMMER, AUTUMN);
        ...
        //Winter values
        HFApi.mining.registerOre(all, ORE.getStateFromEnum(Ore.ROCK), 300D, WINTER);
