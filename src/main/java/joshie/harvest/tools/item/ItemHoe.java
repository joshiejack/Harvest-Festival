...
public class ItemHoe extends ItemToolChargeable {
    ...
    public void addInformation(ItemStack stack, EntityPlayer player, List<String> list, boolean flag) {
        ...
        list.add("-------");
        if (charge < thisTier.getToolLevel()) list.add(TextFormatting.AQUA + "" + TextFormatting.ITALIC + Text.translate("hoe.tooltip.charge"));
        if (charge != 0) list.add(TextFormatting.RED + "" + TextFormatting.ITALIC + Text.translate("hoe.tooltip.discharge"));
    }
    ...
    protected String getLevelName(ItemStack stack, int charges) {
        ...
        return charge == newCharge ? null : Text.translate("hoe.tooltip.charge." + LEVEL_TO_TIER.get(newCharge).name().toLowerCase(Locale.ENGLISH));
    }
}