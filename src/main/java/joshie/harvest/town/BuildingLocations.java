...
public class BuildingLocations {
    ...
    public static final BuildingLocation BARN_WORK = new BuildingLocation(BARN, "barn.work").withDistance(1D).withTime(500);
    ...
    public static final BuildingLocation POULTRY_WORK = new BuildingLocation(POULTRY_FARM, "poultry.work").withDistance(1D).withTime(500);
    ...
    public static final BuildingLocation GENERAL_TILL = new BuildingLocation(SUPERMARKET, "jenni").withDistance(1D).withTime(500);
    public static final BuildingLocation CARPENTER_WORK = new BuildingLocation(CARPENTER, "carpenter.door").withDistance(1D).withTime(500);
    ...
    public static final BuildingLocation CHURCH_WORK = new BuildingLocation(CHURCH, "church.work").withDistance(1D).withTime(1000);
    ...
    public static final BuildingLocation BLACKSMITH_WORK = new BuildingLocation(BLACKSMITH, "blacksmith.work").withDistance(1D).withTime(500);
    ...
    public static final BuildingLocation CLOCKMAKER_WORK = new BuildingLocation(CLOCKMAKER, "clockworker.work").withDistance(1D).withTime(500);
