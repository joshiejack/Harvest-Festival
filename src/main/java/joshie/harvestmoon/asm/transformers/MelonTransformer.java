                ...
                for (int j = 0; j < m.instructions.size(); j++) {
                    ...
                    if (instruction.getType() == AbstractInsnNode.LDC_INSN) {
                        ...
                        if (ldcInstruction.cst.equals("melon")) {
                            ((TypeInsnNode) m.instructions.get(j + 1)).desc = HMModInfo.ASMPATH + "asm/overrides/ItemMelon";
                            ((MethodInsnNode) m.instructions.get(j + 6)).owner = HMModInfo.ASMPATH + "asm/overrides/ItemMelon";
                            ((MethodInsnNode) m.instructions.get(j + 8)).desc = "(Ljava/lang/String;)L" + HMModInfo.ASMPATH + "asm/overrides/ItemMelon;";
                            ((MethodInsnNode) m.instructions.get(j + 8)).owner = HMModInfo.ASMPATH + "asm/overrides/ItemMelon";
                            ((MethodInsnNode) m.instructions.get(j + 10)).desc = "(Ljava/lang/String;)L" + HMModInfo.ASMPATH + "asm/overrides/ItemMelon;";
                            ((MethodInsnNode) m.instructions.get(j + 10)).owner = HMModInfo.ASMPATH + "asm/overrides/ItemMelon";
                            break labelTop;
                        }
                    }
                }
