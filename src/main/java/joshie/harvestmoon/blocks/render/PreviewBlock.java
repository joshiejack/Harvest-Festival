...
public class PreviewBlock implements IBlockAccess {
    ...
    public PreviewBlock setCoordinatesAndDirection(int worldX, int worldY, int worldZ, boolean n1, boolean n2, boolean swap) {
