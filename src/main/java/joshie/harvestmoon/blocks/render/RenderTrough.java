...
public class RenderTrough extends RenderBase {
    ...
    public void renderBlock() {
        if (!isItem()) {
            ...
            boolean onLeft = blockXMinus == HMBlocks.woodmachines && metaXMinus == BlockWood.TROUGH;
            boolean onRight = blockXPlus == HMBlocks.woodmachines && metaXPlus == BlockWood.TROUGH;
