...
public class BuildingFishingHole extends Building {
    public BuildingFishingHole() {
        list = new ArrayList(144);
        list.add(new PlaceableVine(Blocks.vine, 1, 1, 0, 6));
        list.add(new PlaceableBlock(Blocks.sandstone, 0, 2, 0, 2));
        list.add(new PlaceableBlock(Blocks.sandstone, 0, 2, 0, 3));
        list.add(new PlaceableVine(Blocks.vine, 2, 2, 0, 7));
        ...
        list.add(new PlaceableVine(Blocks.vine, 1, 1, 1, 6));
        ...
        list.add(new PlaceableVine(Blocks.vine, 2, 2, 1, 7));
        ...
        list.add(new PlaceableVine(Blocks.vine, 1, 1, 2, 6));
        ...
        list.add(new PlaceableBlock(Blocks.tallgrass, 2, 5, 4, 1));
