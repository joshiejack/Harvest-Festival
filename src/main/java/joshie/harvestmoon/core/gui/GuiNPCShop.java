...
public class GuiNPCShop extends GuiNPC {
    protected static final ResourceLocation gui_texture = new ResourceLocation(HMModInfo.MODPATH, "textures/gui/shop.png");
    protected static final ResourceLocation number_texture = new ResourceLocation(HMModInfo.MODPATH, "lang/en_US/shops.png");
    protected static final ResourceLocation shelve_texture = new ResourceLocation(HMModInfo.MODPATH, "textures/gui/shop_extra.png");
