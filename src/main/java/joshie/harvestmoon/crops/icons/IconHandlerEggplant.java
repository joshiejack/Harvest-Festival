...
public class IconHandlerEggplant implements ICropRenderHandler {
    ...
    public void registerIcons(IIconRegister register) {
        ...
        for (int i = 0; i < stageIcons.length; i++) {
            stageIcons[i] = register.registerIcon(HMModInfo.CROPPATH + HMCrops.eggplant.getUnlocalizedName() + "_" + (i + 1));
        }
    }
}
