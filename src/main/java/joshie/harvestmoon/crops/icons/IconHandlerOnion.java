...
public class IconHandlerOnion implements ICropRenderHandler {
    ...
    public void registerIcons(IIconRegister register) {
        ...
        for (int i = 0; i < stageIcons.length; i++) {
            stageIcons[i] = register.registerIcon(HMModInfo.CROPPATH + HMCrops.onion.getUnlocalizedName() + "_" + (i + 1));
        }
    }
}
