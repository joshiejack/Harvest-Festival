...
public class IconHandlerPumpkin implements ICropRenderHandler {
    ...
    public void registerIcons(IIconRegister register) {
        ...
        for (int i = 0; i < stageIcons.length; i++) {
            stageIcons[i] = register.registerIcon(HMModInfo.CROPPATH + HMCrops.pumpkin.getUnlocalizedName() + "_" + (i + 1));
        }
    }
}
