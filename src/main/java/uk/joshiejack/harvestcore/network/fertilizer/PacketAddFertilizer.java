...
public class PacketAddFertilizer extends PenguinPacket {
    private Fertilizer fertilizer;
    private BlockPos pos;

    public PacketAddFertilizer(){}
    public PacketAddFertilizer(Fertilizer fertilizer, BlockPos pos) {
    ...
    public void handlePacket(EntityPlayer player) {
        FertilizerRender.addBlock(fertilizer, pos);
