...
public class TraitEatsRabbitFood extends AnimalTraitAI {
    public TraitEatsRabbitFood(String name) {
        super(name);
    }
    ...
    public EntityAIBase getAI(EntityAgeable ageable, AnimalStats<?> stats) {
        return new EntityAIEatBowl(ageable, stats, BlockTray.Tray.BOWL_RABBIT);
    }
}
