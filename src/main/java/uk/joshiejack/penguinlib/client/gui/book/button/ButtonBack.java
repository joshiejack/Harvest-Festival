...
public class ButtonBack extends ButtonBook {
    private final Page origin;

    public ButtonBack(Page origin, GuiBook gui, int buttonId, int x, int y) {
    ...
    public void drawButton(@Nonnull Minecraft mc, int mouseX, int mouseY, float partialTicks) {
        if (visible) {
            ...
            drawTexturedModalRect(x, y, 16, (hovered ? 246 : 235), 15, 10);
        }
    }
