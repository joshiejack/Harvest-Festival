...
public class ItemBlockMulti<E extends Enum<E> & IStringSerializable> extends ItemBlock implements IPenguinItem, IPenguinMulti<E> {
    private final Class<E> enumClass;
    private final E[] values;
    private final String prefix;
    private final IPenguinBlock penguin;

    public ItemBlockMulti(ResourceLocation registry, Class<E> clazz, IPenguinBlock block) {
        super((Block) block);
        enumClass = clazz;
