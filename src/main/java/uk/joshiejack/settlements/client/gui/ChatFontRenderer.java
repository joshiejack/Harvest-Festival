...
public class ChatFontRenderer {
    ...
    private static final ResourceLocation resource = GuiElements.getTexture(MODID, "chattext");
    private static final Char2ObjectMap<ChatChar> map = new Char2ObjectOpenHashMap<>();
    ...
    private static boolean renderAsVanilla(GuiNPC gui, String text, int x, int y, int colorInner) {
    ...
    public static boolean render(GuiNPC gui, int x, int y, String text, int colorInner, int colorOuter) {
