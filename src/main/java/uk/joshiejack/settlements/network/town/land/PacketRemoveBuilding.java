...
public class PacketRemoveBuilding extends PenguinPacket {
    ...
    public PacketRemoveBuilding(int dimension, int id, TownBuilding building) {
        this.id = id;
    ...
    public void handlePacket(EntityPlayer player) {
        WorldMap.getTownByID(dimension, id).getLandRegistry().removeBuilding(player.world, building);
    }
}
