...
@PenguinLoader("building_spawner")
public class BuildingSpawnerListingHandler extends ItemListingHandler {
    protected final List<Pair<ItemStack, Long>> items = Lists.newArrayList();

    @Override
    public String getType() {
        return "building_spawner";
    }
    ...
    public ItemStack getObjectFromDatabase(Database database, String data) {
        return AdventureItems.BUILDING.getStackFromResource(new ResourceLocation(data));
    }
}
